			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
				<div className="space-y-6">
					...
					<p className="text-muted-foreground">
						With over 10+ years of experience in web development, I love crafting responsive interfaces that deliver seamless user experiences across devices. With a strong eye for detail and a focus on clean, maintainable code, I aim to turn complex ideas into simple, elegant solutions.
					</p>
